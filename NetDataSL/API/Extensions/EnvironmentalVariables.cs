...
/// <summary>
/// Environmental variables provided by netdata.
/// </summary>
public class EnvironmentalVariables
{
    /// <summary>
    /// Gets the directory where all Netdata-related user configuration should be stored.
    ...
    /// <summary>
    /// Gets the directory where all Netdata -related stock configuration should be stored.
    ...
    /// <summary>
    /// Gets this is a number (probably in hex starting with 0x),
    ...
    /// <summary>
    /// Gets the minimum number of seconds between chart refreshes.
